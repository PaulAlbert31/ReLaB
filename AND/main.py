...
def main():
    ...
    if cfg.dataset == 'miniimagenet':
        from datasets.miniimagenet import get_dataset
        trainset, testset, _ = get_dataset()
        print(len(testset))
    ...
    while (round < cfg.max_round):
        ...
        while lr > 0 and epoch < cfg.max_epoch:
            ...
            if is_best and not cfg.debug or True: #do not use the validation set
